          ...
          <div class="order-options">
            ...
            {if $atex == false}
              <span class="form-check">
                ...
                <span><i class="material-icons rtl-no-flip checkbox-checked">&#xE5CA;</i></span>
                <label for="input_gift" data-tooltip="{l s='Si marca esta casilla su envío se realizará con precinto neutro, y sin Albarán. Si tiene instrucciones adicionales para la entrega, déjelas en el apartado de comentarios' d='Shop.Theme.Checkout'}">{l s='Quiero envío anónimo' d='Shop.Theme.Checkout'}</label >
              </span>
            {/if}

              {*<div id="gift" class="collapse{if $gift.isGift} in{/if}">
                <input type="hidden" id="gift_message" name="gift_message" value="{l s='Envío ANÓNIMO' d='Shop.Theme.Checkout'}">
              </div>*}
            {/if}
