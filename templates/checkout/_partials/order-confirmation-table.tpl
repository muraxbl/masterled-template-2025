 ...
 *}
 {if $customer.id == 18079}
<pre style="display:none" id="SUBTOTALES-ORDER">{$subtotals|var_dump}</pre>
<pre style="display:none" id="TOTALES-ORDER">{$totals|var_dump}</pre>
<pre style="display:none" id="LABELS-ORDER">{$labels|var_dump}</pre>
{/if}
