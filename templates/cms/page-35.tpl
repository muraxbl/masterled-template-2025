...
<html lang="{$language.iso_code}">
  ...
  <head>
      <style>
        ...
        .promo-list .featured-products article .stocklabel {
          display: inline-block;
          position: relative;
        }
        .promo-list h3.subheading-3 {
      ...
      h2#ofertadeldia, h2#restoofertas {
        color: white; font-size: 3em;
        padding: 1em 2em;
        background:#222;
      }
      .promo-list > .indice-productos {
        position: sticky;
        top:0;
        left:0;
        border-radius: 20px;
      ...
      .promo-list > .indice-productos > ul {
        display:flex;
        flex-wrap: nowrap;
        width:100%;
        justify-content: center;
      ...
      .promo-list > .indice-productos > ul li {
        font-size: 0.8em;
        background:#fff;
        text-align: center;
        display: flex;
    ...
    @media(min-width:1099px) {
      .promo-list > .indice-productos > ul li > img {
        display: none;
        opacity:0;
    ...
    @media(max-width:1098px) {
      ...
      .promo-list > .indice-productos > ul li > span {
        display:none;
        opacity:0;
        transition:opacity 0.4s ease-out;
        padding:4px 8px;
      ...
      .promo-list > .indice-productos li:hover {
        flex: 1 0 20%;
      }
      .promo-list > .indice-productos li:hover ~ li {
        flex: 1 1 auto;
      }
      .promo-list > .indice-productos li:hover > span {
        display:block;
        opacity:1;
      }
      .promo-list > .indice-productos li:hover > img {
        display: none;
      }
      .promo-list > .indice-productos > ul li {
        flex: 1 0 calc(100% / 7);
...
<link href="https://fonts.googleapis.com/css2?family=Montserrat:wght@300;400;600&family=Noto+Sans:wght@300;400;500&display=swap" rel="stylesheet">
  ...
  <body id="{$page.page_name}" class="{$page.body_classes|classnames}">
    ...
    <main>
      ...
      <section id="wrapper" style="background: url(/img/fondopromo.jpg) !important;background-size: 100% !important">
...
{block name='content'}
  ...
  <section id="main">
    ...
    {/block}
      ...
      <div style="z-index:99;position: fixed;bottom: 0;left:0;right:0;height:80px;background:white !important;display: flex;justify-content: center;align-content: center;align-items: center;box-shadow:0 -4px 20px -6px rgba(0,0,0,0.4);"><a class="btnregister" href="{$urls.pages.authentication}?back=menos-de-cinco">{l s='Entra y empieza a ahorrar' d='Shop.Theme.Catalog'}</a></div>
      {/if}
	{block name='page_content_container'}
  		<section id="content" class="page-content page-cms page-cms-{$cms.id}" style="background: transparent !important; color:white !important;">
