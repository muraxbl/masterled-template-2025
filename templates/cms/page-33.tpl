...
<link href="https://fonts.googleapis.com/css2?family=Montserrat:wght@300;400;600&family=Noto+Sans:wght@300;400;500&display=swap" rel="stylesheet">
  ...
  <body id="{$page.page_name}" class="{$page.body_classes|classnames}">
    ...
    <main>
      ...
      <section id="wrapper" style="background: #000 !important">
...
{block name='content'}
  ...
  <section id="main">
    ...
    {/block}
      ...
      <div style="z-index:99;position: fixed;bottom: 0;left:0;right:0;height:80px;background:white !important;display: flex;justify-content: center;align-content: center;align-items: center;box-shadow:0 -4px 20px -6px rgba(0,0,0,0.4);"><a class="btnregister" href="{$urls.pages.authentication}?back=black-friday">{l s='Registráte o entra para ver los descuentos' d='Shop.Theme.Catalog'}</a></div>
      {/if}
	{block name='page_content_container'}
  		<section id="content" class="page-content page-cms page-cms-{$cms.id}" style="background: #000 !important; color:white !important;">
    		{block name='cms_content'}
            {assign var=dealsdate value='1732518000'}
            {if $smarty.now >= 1732518000}
            Es hora
            {else}
            Aún no es hora
            {/if}
...
<iframe data-w-type="embedded" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="https://xmwkr.mjt.lu/wgt/xmwkr/z62/form?c=1a9d4570" width="100%" style="height: 0;"></iframe>
