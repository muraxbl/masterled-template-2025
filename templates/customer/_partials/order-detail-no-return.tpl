...
{block name='order_products_table'}
  <div class="box d-none d-sm-none d-md-block">
      ...
      <tfoot>
        ...
        {/foreach}
         <!--  <tr class="text-xs-right line-{$order.totals.total.type}">
          <td colspan="3">{l s='Impuestos' d='Shop.Theme.Customer'}</td>
          <td>{*math equation="x - y" x=$order.totals.total_including_tax.amount y=$order.totals.total.amount assign="impuestos"}{$impuestos|number_format:2:",":"."*} €</td>
        </tr> -->
  ...
  <div class="order-totals d-md-none box">
    ...
    {/foreach}
    <div class="order-total row">
      <div class="col-xs-8"><strong>{l s='Impuestos' d='Shop.Theme.Customer'}</strong></div>
      <div class="col-xs-4 text-xs-right">{math equation="x - y" x=$order.totals.total_including_tax.amount y=$order.totals.total.amount} €</div>
    </div>
    <div class="order-total row">
