  ...
  {if $cart_rules}
    <table class="table table-striped table-bordered d-none d-sm-none d-md-block">
      ...
      <tbody>
        ...
        {assign var=cupones value=['','SRFN5','5DAVAIZ','HACHE','VERANOMASTER', 'EFFPESZX', 'BFMLED24-10']}
        {if in_array($cart_rule.code, $cupones)}
        {else}
    ...
    <div class="cart-rules d-md-none">
      {foreach from=$cart_rules item=cart_rule}
                {assign var=cuponno value=['','SRFN5','5DAVAIZ','HACHE','VERANOMASTER']}
        {if in_array($cart_rule.code, $cuponno)}
        {else}
