...
<div id="_desktop_currency_selector">
  <div class="currency-selector dropdown js-dropdown">
    ...
    <button data-target="#" data-toggle="dropdown" class="d-none d-sm-none d-md-block btn-unstyle" aria-haspopup="true" aria-expanded="false" aria-label="{l s='Currency dropdown' d='Shop.Theme.Global'}">
      <span class="expand-more _gray-darker">{$current_currency.iso_code} {$current_currency.sign}</span>
      <i class="material-icons expand-more">&#xE5C5;</i>
    </button>
    <ul class="dropdown-menu d-none d-sm-none d-md-block" aria-labelledby="currency-selector-label">
