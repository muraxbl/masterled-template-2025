...
{function name="menu" nodes=[] depth=0 parent=null}
    {if $nodes|count}
      <ul class="top-menu" {if $depth == 0}id="top-menu2"{/if} data-depth="{$depth}">
        {foreach from=$nodes item=node}
            ...
            {assign var=_counter value=$_counter+1}
              ...
              > {*LC: 11/12/19*}{if $depth >= 1}{* EN CATEGORIAS D NIVEL NO SUPERIOR, MOSTRAR MINIATURA DE CATEGORÍA AL LADO DEL NOMBRE SI EXISTE *}
                  ...
                  {if $imagencat|file_exists}<img border="0" class="mainmenu-cat-img" src="{$urls.img_cat_url}{$mainmenuCatId[1]}.jpg">{/if}
...
<div class="menu js-top-menu position-static d-none d-sm-none d-md-block" id="_desktop_top_menu_2">
